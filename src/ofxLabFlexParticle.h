...
namespace lab {
    ...
    public:
         ...
         * @return      A particle
         */
        Particle( const ParticleOptions& opts );
        
        /**
         * Particle virtual deconstructor
         *
         */
        virtual ~Particle() {}
        
        /**
         * Particle equal operator
         *
         ...
         *
         */
        virtual void repel( const Particle& b );
