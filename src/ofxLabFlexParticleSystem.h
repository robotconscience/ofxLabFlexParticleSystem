...
namespace lab {
    ...
    public:
        ...
        typedef map<unsigned long, Particle*>                         Container;
        
        typedef map<unsigned long, Particle*>::iterator               Iterator;
        typedef map<unsigned long, Particle*>::reverse_iterator       RIterator;
        
        typedef map<unsigned long, Particle*>::const_iterator         const_Iterator;
        typedef map<unsigned long, Particle*>::const_reverse_iterator const_RIterator;
        ...
        /* sets internal options
            ...
            VECTOR_FIELD = use the VectorField for calculations
            VECTOR_FIELD_DRAW = draw the VectorField forces (visual reference tool)
         */
        enum Options { 
            VERTICAL_WRAP       = (1u << 0),
        ...
        /**
         * Inserts an Particle into the system.
         * NOTE: no memory management is done by this system
         *
         * @param particle      pointer to the Particle you want added
         */
         ...
         */
        void setWallCallback( std::tr1::function<void ( Particle* )> func,
         ...
         */
        Particle * getParticle( unsigned long uniqueID );
         ...
         *
         * @return              VectorField pointer
         */
        VectorField * getVectorField();
        
        /**
         * Apply a given VectorField to the particles.  This is useful for advanced
         ...
         */
        bool shouldDraw( Particle* particle,
    ...
    protected:
        ...
        Quad          _worldQuad;    // if quad world, this is the bounds
        ...
        std::tr1::function<void ( Particle* )>    _wallCallbacks [SUPPORTED_WALL_CALLBACKS];
        ...
        VectorField   _vectorField;   // our vector field
